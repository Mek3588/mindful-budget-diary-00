    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-9 w-9 bg-gray-800 border-gray-700 text-gray-100 p-0 hover:bg-gray-700 hover:text-white"
        ),
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-gray-800 rounded-lg",
          props.mode === "range"
